module github.com/ankorstore/yokai-showroom/worker-demo

go 1.20

require (
	cloud.google.com/go/pubsub v1.37.0
	github.com/ankorstore/yokai-contrib/fxgcppubsub v1.1.0
...
require (
	...
	github.com/ankorstore/yokai/worker v1.1.0 // indirect
